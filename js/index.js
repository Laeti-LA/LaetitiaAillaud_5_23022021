...
// Fonction pour récupérer les produitss : 
...
function displayProduct(product) {
    ...
    cloneElt.getElementById("card__link").href = `pages/products.html?id=${product._id}` //URL de la fiche produit correspondante 
    cloneElt.getElementById("card__img").src = product.imageUrl //Image du produit
    cloneElt.getElementById("card__name").textContent = product.name //Nom du produit 
